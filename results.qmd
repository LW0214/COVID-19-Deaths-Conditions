...
2.  **Seasonal Viruses**: The winter months coincide with the flu season, where other respiratory viruses are also prevalent, potentially complicating and exacerbating COVID-19 cases.

3.  **Holiday Seasons**: Winter months include holidays (Christmas, New Years, etc) that typically involve family gatherings and increased social interaction, providing more opportunities for the virus to spread.

Conversely, during summer, while the outdoor activities may generally reduce the transmission rate compared to winter, we still observe increases in deaths. This could be due to:

1.  **Social Activities**: Summer holidays and events can result in gatherings and increased contact among individuals, leading to potential spikes.

2.  **Air Conditioning**: Increased use of air conditioning during hot months can lead to similar indoor circulation patterns as in winter, potentially facilitating the spread of the virus.

## Geographical Variations

We have observed a recurring pattern in COVID-19 deaths over time, with seasonal factors playing a notable role in the fluctuation of death rates. While time allows us to track flow of the pandemic's impact, geography provides another critical dimension for understanding the spread and toll of the virus.
...
The above is a bar chart comparing the proportion of the population to the proportion of COVID-19 deaths across various age groups for the years 2020-2021. The left side of the chart displays the composition of the general population across age cohorts, while the right side shows the corresponding proportions of COVID-19 related deaths. As expected, the bar charts highlight the disproportionate impact of COVID-19 on different age groups. As the age groups get older, they show a larger discrepancy, with their proportion of deaths far exceeding their representation in the population.
...
1.  **Increase in proportion involving influenza and pneumonia, respiratory failure:** The increase in proportions of people with deaths related to respiratory conditions may reflect the emergence of new, more virulent virus strains, which are more contagious and lethal. This highlights the ever-evolving challenge the virus poses.

2.  **Decline in proportion of hypertensive diseases:** On the flip side, the observed decline in proportion of deaths associated with conditions like hypertensive diseases could be linked to the increased protective measures and medical interventions that became available over time, including the widespread administration of vaccines.
...
It is interesting to note that while these conditions generally follow the same trend, there are certain periods where we observe opposite trends. For example, in 2020 Q4 to 2021 Q1, we see an increase in deaths involving conditions such as influenza, pneumonia, cardiac arrest, and respiratory failure but a decrease in deaths involving diabetes and hypertensive diseases. These trends will be further explored in the 'Interactive Graph' section of our report.
...
ggplot(melt(wide_data), aes(x = variable, y = Condition, fill = value)) +
  ...
  labs(x = "Age Group", y = "Condition", fill = "COVID-19 Deaths") +
  theme_minimal() +
...
Building on the insights provided by the heat map, let's turn our focus to the comparative impact of specific health conditions within different age cohorts. The chart above distinctly categorizes the frequency of conditions found in conjunction with COVID-19 fatalities, setting apart the top five deadliest comorbidities within the age groups: young (0-24), middle-aged (25-54), and old (55+). From this chart, several points can be inferred:

1.  **Prevalence of Obesity in Younger Age Groups:** In older age groups, other health conditions such as heart disease, respiratory diseases, and diabetes may become more prevalent and pose a greater risk of death than obesity. As a result, these conditions may overshadow obesity as a leading contributor to COVID-19 mortality in this demographic. Furthermore, obesity not being in the top 5 for the older population could indicate survivorship bias. Older individuals with severe obesity may have a higher mortality rate at a younger age, leading to a decreased representation of obesity-related deaths in the older age cohorts.
...
3.  **Co-existing conditions:** The presence of multiple conditions among the top causes of death, particularly in the older age group, suggests comorbidities are a common factor in COVID-19-related deaths.
