...
new_covid=covid_data %>% mutate(Month = ifelse(Group == "By Total", -1, Month))
...
the dataset, which is quite large. We decide to impute the entries for
"COVID-19 Deaths"and "Number of Mentions" as the average between 0 to
10, which is 5.
