...
the dataset, which is quite large. As shown in the below code for Alaska, apparently "all ages" already
...
is an aggregation of all months in that year. After replacing these implicit
