...
The [percentage]{style="color:red;"} shows the change of the current value you're [currently on]{style="color:#6a3d9a;"} compared to the prevous value you've [previously clicked]{style="color:#b15928;"}. Note: percentage only shows up once you've clicked on a button, red indicates percentage increase or no change, and green indicates decrease.
